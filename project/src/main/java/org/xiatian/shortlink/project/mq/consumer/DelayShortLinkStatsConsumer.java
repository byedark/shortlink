...
import static org.xiatian.shortlink.project.common.constant.RedisKeyConstant.DELAY_QUEUE_STATS_KEY;
                    ...
                    for (; ; ) {
                        try {
                            ...
                            if (statsRecord != null) {
                                ...
                                try {
                                    redirectService.shortLinkStats(null, null, statsRecord);
                                } catch (Throwable ex) {
